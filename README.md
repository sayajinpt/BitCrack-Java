in incremental mode it will save the checkpoint in a file save.txt, next time u satrt incremental it will continue from the saved checkpoint if the save file exists.
